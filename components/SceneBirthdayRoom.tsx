...
const SceneBirthdayRoom: React.FC<SceneBirthdayRoomProps> = ({
  onNextScene,
}) => {
  ...
  return (
    <div
      className={`relative w-full h-full flex flex-col items-center justify-center text-center p-8 transition-opacity duration-1000 overflow-hidden ${
    ...
    >
      ...
      <div className="relative bg-black bg-opacity-30 p-8 rounded-2xl shadow-2xl max-w-2xl z-10">
        ...
        <p className="text-lg md:text-xl text-pink-100 mb-8">
          A special room, just for you, filled with party decorations. And look,
          there's a cake waiting!
        </p>
