...
const SceneClosingCurtains: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden flex items-center justify-center">
      ...
      <div
        className={`z-20 text-center transition-opacity duration-500 ${
          isClosing ? "opacity-0" : "opacity-100"
        }`}
      >
        <h1 className="text-4xl md:text-6xl font-dancing text-rose-200 mb-4">
          Happy Birthday once again Tulsu, My Love.
        </h1>
        <p className="text-3xl md:text-5xl font-dancing text-rose-100 mb-8">
          I Love You ❤️
        </p>
        <button
          onClick={handleEnd}
